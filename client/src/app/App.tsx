...
import {contractsMock} from "../contract/contractApi";
import map from "../img/map1.png";

const App: React.FC = () => {
    const agents = agentMock

    const contracts = contractsMock
        ...
        <React.Fragment>
            ...
            <div className="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
                <main role="main" className="d-flex flex-row">
                    <div className="col-7">
                        <img className="img-fluid mx-auto" width="600px" alt={'map'} src={map}/>
                        <RangeInput value={selectedAgents} changeValue={changeSelectedAgents} maxValue={agentAmount}/>
                    </div>
                    <div className="col-5 ">
                        <div className="pb-2">

                            <DriversStats contracts={contracts}/>
                        </div>
